          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-12 mb-12">
            ...
            <div className="lg:col-span-2">
              <div className="flex items-center space-x-3 mb-6">
                <div className="relative">
                  <div className="w-14 h-14 bg-gradient-to-br from-blue-600 to-indigo-600 rounded-2xl flex items-center justify-center shadow-strong">
                    <span className="text-white font-black text-xl">NC</span>
                  </div>
                  <div className="absolute -top-1 -right-1 w-5 h-5 bg-green-500 rounded-full border-2 border-gray-900"></div>
                </div>
                <div>
                  <span className="text-3xl font-black text-white">NGO Connect</span>
                  <div className="text-sm text-gray-400 font-medium">Empowering Change Worldwide</div>
                </div>
              </div>
              
              <p className="text-gray-300 mb-6 max-w-md leading-relaxed text-lg">
                Connecting generous hearts with meaningful causes. We bridge the gap between donors and NGOs 
                to create lasting impact in communities worldwide through transparent, secure donations.
              </p>
              
              <div className="flex space-x-4 mb-8">
                <a 
                  href="#" 
                  className="w-12 h-12 bg-white/10 hover:bg-white/20 rounded-xl flex items-center justify-center transition-all duration-300 hover:scale-110 group"
                >
              ...
              <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10">
                ...
                <p className="text-gray-300 text-sm mb-4">Get the latest impact stories and donation opportunities</p>
            ...
            <div>
              ...
              <ul className="space-y-4">
                ...
                <li>
                  <Link to="/browse" className="text-gray-300 hover:text-white transition-colors flex items-center group">
                    <svg className="w-4 h-4 mr-2 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                    </svg>
                    Browse NGOs
                ...
                <li>
                  <Link to="/donations/requests" className="text-gray-300 hover:text-white transition-colors flex items-center group">
                    <svg className="w-4 h-4 mr-2 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                    </svg>
                    Donation Requests
          ...
          <div className="border-t border-gray-700 pt-8 flex flex-col lg:flex-row justify-between items-center">
            <div className="flex items-center space-x-4 mb-4 lg:mb-0">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-xs text-gray-500">Platform Status: All Systems Operational</span>
              </div>
            </div>
